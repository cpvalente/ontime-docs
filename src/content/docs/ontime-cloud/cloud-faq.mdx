---
title: Cloud FAQ
description: Frequently asked questions about Ontime Cloud hosting, stages, teams, billing, project portability, and production access.
---
...
This means you can run 3 simultaneous projects, one in each stage. \
