...
The most straightforward way to get Ontime synced with vMix is by using Ontime's [HTTP API](add-link), which provides easy access to the apps playback functions
