...
Ontime also improves team collaboration with dedicated views for cuesheets and operators, and signage screens.
...
:::tip[Have an idea?]
Reach out via email at [mail@getontime.no](mailto:mail@getontime.no), [open an issue in GitHub](https://github.com/cpvalente/ontime/issues) or join our [Discord server](https://discord.com/invite/eje3CSUEXm).
:::
