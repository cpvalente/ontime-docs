...
:::note
This view can be customised using the [URL Parameters editor](/quick-tips/configuring-views)
:::
...
| URL                                   | See the docs                                         |
| :------------------------------------ | :--------------------------------------------------- |
| `http://MY-IP-ADDRESS:4001/timer`     | [Timer](/interface/backstage/stage-timer)            |
