...
description: Send secondary messages to Ontime presenter and stage timer views for live production communication.
---

You can show any text as a secondary field in the [stage timer](/interface/automated/stage-timer).

![Timer with external data](../../../assets/screenshots/views/4-timer.png)
