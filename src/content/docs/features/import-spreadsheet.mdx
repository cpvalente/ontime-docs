...
![Spreadsheet template](../../../assets/screenshots/feature/spreadsheet-template.png)
Follow [here](https://docs.google.com/spreadsheets/d/1TYZhAELRFQa\_2QBO8Q651fMHdem6AXmFLjEDoksJd8Y/edit?usp=sharing) to see the Google Sheet from the screenshot
