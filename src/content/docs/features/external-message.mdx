...
See the documentation on setting the external message using the [OSC](/api/protocols/osc/#example-change-the-external-message) or [WebSocket API](/api/protocols/websockets/#example-change-the-external-message).
