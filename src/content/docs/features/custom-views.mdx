...
description: Build custom Ontime browser views for production displays, confidence monitors, signage, and role-specific timing interfaces.
---
...
You can find [the code from the demo here](https://github.com/cpvalente/ontime/tree/master/apps/server/src/external).
