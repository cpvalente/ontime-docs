...
Additionally, if a live connection is required, the [Google Sheet integration](/features/import-spreadsheet-gsheet) has the ability to read and write to a remote sheet.
