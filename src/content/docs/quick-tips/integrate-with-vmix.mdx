...
description: Integrate Ontime with vMix using HTTP control and automation to synchronize rundowns, timers, and live production graphics.
---
...
![Setup HTTP Integration](../../../assets/screenshots/features/vmix_setup-automation.png)
