---
title: OSC API
description: OSC API reference for controlling Ontime timers, playback, rundowns, and live production automation.
---
...
# See below
/ontime/message/secondary <new-text>
```
...
**OSC Message**
```bash
/ontime/addtime/add <value-in-milliseconds>
```

### Remove time
**OSC Message**
```bash
/ontime/addtime/remove <value-in-milliseconds>
```
...
**OSC Message**
```bash
/ontime/auxtimer/1/duration <value-in-milliseconds>
```
...
**OSC Message**
```bash
/ontime/auxtimer/1/addtime <value-in-milliseconds>
```
