...
The [HTTP API](add-link) has access to a smaller subset of features, but it can be handy for integration with software such as vMix.
...
[Read the docs](add-link) for more information.
