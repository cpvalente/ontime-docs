...
| `eventNow` `eventNext`   |                       | **currently loaded event / upcoming event**, [see event data](/api/data/event-data)              |          | 
| `publicEventNow` `publicEventNext` |             | **currently public loaded event / upcoming event**, [see event data](/api/data/event-data)       |          | 
