---
title: OSC and WebSocket APIs
description: OSC and WebSocket APIs
---
...
The [HTTP API](api/http) has access to a smaller subset of features.
...
| -------------------------- | ------------------------------ | ----------------------------------------------------------- | ---------------------------------------------------------------- |
| test-ontime                |                                |                                                             | "hello"                                                          |
| ontime-poll                |                                | Returns the entire runtime state                            | topic: "poll", payload: |
...
| get-playback               |                                | Returns playback portion  | topic: "playback", payload:            |
| get-timer                  |                                | Returns timer portion     | topic: "timer", payload:              |
