...
:::note[Notes on OSC]
All OSC requests must start with `/ontime`
:::

| Address                        | Arguments                  | Description                                                                            |
| ------------------------------ | -------------------------- | -------------------------------------------------------------------------------------- |
| /change/[id]/[property]        | ?????                      | changes the [property](../api-details/#event-properties) of event with `ID` to `value` |
| /message/[destination]/text    | string                     | Sets text of [destination](../api-details/#message-destination) message                |
| /message/[destination]/visible | boolean                    | Sets visibility [destination](../api-details/#message-destination) message             |
...
| /auxtimer/1/start            |                            | Starts auxtimer1                                                                     |
| /auxtimer/1/stop             |                            | Stops auxtimer1                                                                      |
| /auxtimer/1/pause            |                            | Pauses auxtimer1                                                                     |
| /auxtimer/1/duration         | number                     | Sets duration of auxtimer1                                                           |
| /auxtimer/1/direction        | "count-up" \| "count-down" | Sets direction of auxtimer1                                                          |
...
A sucessfule call will result in a `202` responds and a body with a \{payload\} object
:::
...
| /change/[id]           | ?[property]=[value]                                        | "changes pending"               | changes the [property](../api-details/#event-properties) of event with `ID` to `value`   |
| /message/[destination] | ?text=[string]&visible=[true \| false]                     | [MessageState](../)             | Sets text and/or visibility of [destination](../api-details#message-destination) message |
...
| /auxtimer/1/start    |                                                            | [TimerState](../)               | Starts auxtimer1                                                                       |
| /auxtimer/1/stop     |                                                            | [TimerState](../)               | Stops auxtimer1                                                                        |
| /auxtimer/1/pause    |                                                            | [TimerState](../)               | Pauses auxtimer1                                                                       |
| /auxtimer/1          | ?duration=[number]&direction=["count-up" \| "count-down" ] | [TimerState](../)               | Sets duration and/or direction of auxtimer1                                            |
...
| /auxtimer/1/stop     | [TimerState](../)               | Stops auxtimer1                                                    |
| /auxtimer/1/pause    | [TimerState](../)               | Pauses auxtimer1                                                   |
| /auxtimer/1          | [TimerState](../)               | Sets duration and/or direction of auxtimer1                        |
